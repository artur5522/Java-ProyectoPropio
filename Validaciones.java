...
public class Validaciones {
    ...
    public static long validaDni() throws InputMismatchException {
        Scanner sc = new Scanner(System.in);
    ...
    public static int validaAñoNacimiento() throws InputMismatchException {
        Scanner sc = new Scanner(System.in);
    ...
    public static String validaDomicilio(String departamentos[], String individuo) throws InputMismatchException {
        Scanner sc = new Scanner(System.in);
        String depa = "";
        String calle = "";
        int numercion = 0;
    ...
    public static int validaAñoLctivo() throws InputMismatchException {
        Scanner sc = new Scanner(System.in);
    ...
    public static double validaNota() throws InputMismatchException {
        Scanner sc = new Scanner(System.in);
    ...
    public static long validaLegajoAlumno(ArrayList<Alumno> alumnado) throws InputMismatchException {
        Scanner sc = new Scanner(System.in);
